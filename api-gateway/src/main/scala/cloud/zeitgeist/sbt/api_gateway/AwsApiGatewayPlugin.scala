...
import cloud.zeitgeist.sbt.api_gateway.HttpApiDeployer.{ApiIdOutput, DefaultStageName}
import cloud.zeitgeist.sbt.lambda.AWSLambdaPlugin
import cloud.zeitgeist.sbt.{LambdaName, Region}
