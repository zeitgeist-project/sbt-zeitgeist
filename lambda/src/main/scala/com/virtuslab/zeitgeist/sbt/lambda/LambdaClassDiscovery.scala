...
private[lambda] object LambdaClassDiscovery {
  ...
  private val httpAnnotationPackage = "com.virtuslab.zeitgeist.lambda.api.http.macros"
  ...
  private val directAnnotationPackage = "com.virtuslab.zeitgeist.lambda.api.direct"
